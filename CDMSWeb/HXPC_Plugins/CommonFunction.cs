            ...
            try
            {
                if (((wf != null) && (wf.DocList != null)) && (wf.DocList.Count > 0))
                {
                    foreach (Doc doc in wf.DocList)
                    {
                        ...
                        {
                            case "CHECK":
                                htUserKeyWord.Add("PREPAREDSIGN1", doc.dBSource.LoginUser.Code);
                                goto Label_04DA;

                            case "AUDIT":
                                htUserKeyWord["CHECKPERSON"] = doc.dBSource.LoginUser.Code;
                            ...
                            case "MORESIGN":
                                ...
                                {
                                    if (doc.dBSource.LoginUser.Code == user2.User.Code)
                                    {
                                        htUserKeyWord["AUDITPERSON"] = doc.WorkFlow.CuWorkState.PreWorkState.WorkUserList[0].User.Code;
                            ...
                            case "END":
                                {
                                    ...
                                    {
                                        htUserKeyWord["APPROVEPERSON"] = doc.dBSource.LoginUser.Code;
                                    }
                        ...
                        {
                            htUserKeyWord["AUDITPERSON"] = doc.dBSource.LoginUser.Code;
                        }
                        Label_0385:
                        htUserKeyWord["AUDITTIME"] = DateTime.Now.ToString("yyyy.MM.dd");
                        Label_04DA:
                        if ((str.EndsWith(".DOC") || str.EndsWith(".DOCX")) || (str.EndsWith(".XLS") || str.EndsWith(".XLSX")))
                        {
                            ...
                            try
                            {
                                ...
                                office.WriteDataToDocument(doc, locFileName, htUserKeyWord);
                            }
