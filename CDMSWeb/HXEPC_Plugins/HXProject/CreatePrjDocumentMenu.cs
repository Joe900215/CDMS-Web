        ...
        public override enWebMenuState MeasureMenuState()
        {
            try
            {
                ...
                if (project != null)
                {
                    ...
                    parentProject.Description.IndexOf("综合管理") >= 0)
                        &&
                        (parentProject.ParentProject.Code == "项目管理" ||
                        parentProject.ParentProject.Description == "项目管理" ||
                        parentProject.ParentProject.Code == "项目综合管理"))
                    {
                        flag = true;
                    }
                    //bool flag = false;
