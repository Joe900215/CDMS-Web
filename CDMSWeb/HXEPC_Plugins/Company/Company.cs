...
namespace AVEVA.CDMS.HXEPC_Plugins
{
    public class Company
    {
        ...
        /// 新建厂家资料目录
        /// </summary>
        public static JObject CreateCompany(string sid, string ProjectKeyword, string companyAttrJson)
        {
            return EditCompanyInfo.CreateCompany(sid, ProjectKeyword, companyAttrJson);
   
        }

        public static JObject DeleteCompany(string sid, string ProjectKeyword, string CompanyCode, string CompanyId) {
            return EditCompanyInfo.DeleteCompany(sid, ProjectKeyword, CompanyCode, CompanyId);
        }
        ...
        public static JObject GetSelectUnitList(string sid, string ProjectKeyword, string Filter,string UnitType)
        {
            return SelectUnit.GetSelectUnitList(sid, ProjectKeyword, Filter, UnitType);
        }

        public static JObject GetSelectProfessionList(string sid, string ProjectKeyword, string page, string Filter)
        {
            return SelectProfession.GetSelectProfessionList(sid, ProjectKeyword, page, Filter);
        }
        ...
        public static JObject GetSelectContractList(string sid, string ProjectKeyword, string page, string Filter)
        {
            return SelectContract.GetSelectContractList(sid, ProjectKeyword, page, Filter);
