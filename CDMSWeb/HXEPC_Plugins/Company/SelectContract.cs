    ...
    public class SelectContract
    {
        ...
        public static JObject GetSelectContractList(string sid, string ProjectKeyword, string page, string Filter)
        {
            ...
            try
            {
                ...
                string curContractCode = "";

                curContractCode = prjProject.Code;//.GetValueByKeyWord("PRO_COMPANY");
                if (string.IsNullOrEmpty(curContractCode))
                {
                    reJo.msg = "获取项目来源失败！";
                    return reJo.Value;
                }
                ...
                foreach (DictData data6 in dictDataList)
                {
                    ...
                    if (data6.O_sValue1 != curContractCode)
                    {
                        continue;
                    }
                ...
                //    {
                //        JObject joData = new JObject(
                //            new JProperty("contractType", "项目部门"),
                //            new JProperty("contractId", data6.O_ID.ToString()),
                //            new JProperty("contractCode", data6.O_Code),
                //            new JProperty("contractDesc", data6.O_Desc)
                //            );
                ...
                //            new JProperty("contractType", "项目部门"),
                //            new JProperty("contractId", data6.O_ID.ToString()),
                //            new JProperty("contractCode", data6.O_sValue1),
                //            new JProperty("contractDesc", data6.O_Desc)
                //            );
                //        jaData.Add(joData);
                //    }
