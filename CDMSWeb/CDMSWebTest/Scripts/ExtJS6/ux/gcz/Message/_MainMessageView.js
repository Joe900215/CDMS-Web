/*定义数据源视图面板*/
Ext.define('Ext.ux.gcz.Message._MainMessageView', {
    ...
    initComponent: function () {
        ...
        ////定义消息列表
        me._mainmessagegrid = Ext.create('Ext.ux.gcz.Message._MainMessageGrid');

        ////定义消息内容控件
        me.mainmessagecontent = Ext.create('Ext.ux.gcz.Message._MainMessageContent');
