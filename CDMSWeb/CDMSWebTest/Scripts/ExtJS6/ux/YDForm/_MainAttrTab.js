...
Ext.define('Ext.ux.YDForm._MainAttrTab', {
    ...
    initComponent: function () {
        ...
        me._RightGrid = Ext.create('Ext.ux.YDForm.Right._RightGrid');
        ...
        me._ProjectAttrTabItem = Ext.create('Ext.panel.Panel', {
            title: '目录属性',
            //xtype: 'grid',
            layout: 'fit',
            xtype: 'panel',
        ...
        me.mainattrtab = Ext.create('Ext.tab.Panel', {
            ...
            {
                title: "权限列表", layout: "anchor", hidden: true,
                items: [me._RightGrid
                ]
            }
            ], listeners: {
    ...
    //显示或隐藏权限列表
    setRightTabVisible: function (value) {
        var me = this;

        if (value === true) {
            me.mainattrtab.tabBar.items.items[7].show();
        } else {
            me.mainattrtab.tabBar.items.items[7].hide();
        }
    },
