/*定义数据源视图面板*/
Ext.define('Ext.ux.m.Project._MainProjectView', {
    ...
    initComponent: function () {
        ...
        ////定义目录树
        me._mainprojecttree = Ext.create('Ext.ux.m.Project._MainProjectTree');

        //////定义文档列表
        me._maindocgrid = Ext.create('Ext.ux.m.Doc._MainDocGrid');
