Ext.define('CDMSWeb.controller._Navigation', {
    ...
    models: [
        'Category', 'ProjectTree', 'LogicProjectTree', 'UserCustomTree', 'GlobSearchTree', 'CategoryCombo', '_DocList', 'WorkFlowPage'
    ],
    ...
    views: [
        '_Navigation.View', 'Ext.ux.YDForm._contextMenu'
    ],
    ...
    refs: [
         ...
         { ref: "_NavigationPanel", selector: "#_navigationPanel" }
    ...
    init: function () {
        var me = this,
            //win = CDMSWeb.view.Content.CategoryEdit,
            panel = me.get_NavigationPanel();  //获取ContentPanel实例
        me.view = Ext.widget("_navigationview");//视图路径：\Scripts\app\view\Content\View.js
        panel.add(me.view);
