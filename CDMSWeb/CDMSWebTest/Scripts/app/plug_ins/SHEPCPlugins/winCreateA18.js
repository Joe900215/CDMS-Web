//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA18', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.18", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "我方接到编号为", anchor: "80%", labelWidth: 100, labelAlign: "left",margin: '10 5 0 0', width: 235//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "的监理工程师通知后，已按要求完成", labelWidth: 210, labelAlign: "left", margin: '10 5 0 0', width: 345//flex: 1
        });
            ...
            listeners:
{
    ...
    send_create_A18: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA18",
