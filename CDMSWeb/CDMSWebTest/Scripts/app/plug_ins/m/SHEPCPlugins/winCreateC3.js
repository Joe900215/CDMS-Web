//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateC3', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "C.3", readOnly: true,
                  ...
                  {//发文编号一栏
                      ...
                      }, 
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "工程设计变更通知单，请会检。", margins: "13 0 0 0"
                              }, ]
                      },me.contentText,
                  {
                      layout: "vbox",
