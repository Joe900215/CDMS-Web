//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA1', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA1',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.professiondata = [{ text: "DQ", value: "DQ" }, { text: "GD", value: "GD" }, { text: "GL", value: "GL" },
			...
			{ text: "YB", value: "YB" }, { text: "TS", value: "TS" }
        ];//专业combo
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.1", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "我方承担的", anchor: "80%", labelWidth: 70, labelAlign: "left", margin: '10 5 0 0', width: 280//flex: 1
        });
        //添加内容Text
        ...
        me.toDateField = Ext.create("Ext.form.field.Date", {
            ...
            anchor: '100%',
            fieldLabel: ' 工程，已完成了开工前的各项准备工作，特申请于',
            labelWidth: 280, labelAlign: "left", margin: '10 0 0 0',Width: 360,
                  ...
                  items: [
                      {
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                          {
                              ...
                              cls: 'classDiv2',
                              itemId: 'label1',
                              text: 'A.1工程开工报审表', margins: '0 0 0 10'
    ...
    send_create_a1: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA1",
