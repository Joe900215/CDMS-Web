//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA20', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.20", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "我方承担", anchor: "80%", labelWidth: 80, labelAlign: "left", margin: '10 5 0 0', width: 330//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "竣工，由于", anchor: "80%", labelWidth: 80, labelAlign: "left", margin: '0 5 0 0', width: 330//flex: 1
        });
        ...
        me.toDateField = Ext.create("Ext.form.field.Date", {
            xtype: 'datefield',
            anchor: '100%',
            fieldLabel: ' 工程施工任务，根据合同规定应于', fieldStyle: 'border-color: red; background-image: none;',
            labelWidth: 200, labelAlign: "left", margin: '10 5 0 0',
            format: 'Y年m月d日',
            name: 'to_date',
        ...
        //日期控件
        me.toDateField2 = Ext.create("Ext.form.field.Date", {
                xtype: 'datefield',
                anchor: '100%',
                fieldLabel: '原因，现申请工期变更至', fieldStyle: 'border-color: red; background-image: none;',
                labelWidth: 140, labelAlign: "left", margin: '0 5 0 0', labelSeparator: '',
                format: 'Y年m月d日',
                name: 'to_date',
                value: new Date()  // defaults to today
            }
            ...
            listeners:
{
    ...
    send_create_A20: function () {
        ...
        var toDate2 = me.toDateField2.value;
