//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateC1', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "C.1", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "现报上", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '10 5 0 0', width: 210//flex: 1
        });
        //添加内容Text
            ...
            listeners:
{
                  ...
                  {//发文编号一栏
                      ...
                      }, 
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "工程设计计划/图纸交付进度计划，请审查。", margins: "13 0 0 0"
                              }, ]
                      },me.contentText,
                  {
                      layout: "vbox",
    ...
    send_create_C1: function () {
        ...
        Ext.Ajax.request({
            url: 'SHEPCPlugins/CreateC1',
            method: "POST",
            params: {
                //IsUpEdition:是否升版,filelist：文件列表，action：操作命令
                action: me.winAction, ProjectKeyword: projKeyword, docNum: me.docNum, title: title, content: content, filelist: filelist, IsUpEdition: "flase", sid: localStorage.getItem("sid")
            },
            success: function (response, options) {
                var recod = eval(res.data[0]);
