//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA17', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.17", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "根据承包合同条款", anchor: "80%", labelWidth: 110, labelAlign: "left", margin: '10 5 0 0', width: 185//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "条的规定，由于", anchor: "80%", labelWidth: 100, labelAlign: "left", margin: '10 5 0 0', width: 175//flex: 1
        });
        //添加事由text
        me.titleText3 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "的原因，我方要求索赔金额（大写）", anchor: "80%", labelWidth: 200, labelAlign: "left", margin: '10 5 0 0', width: 290//flex: 1
        });
        //添加内容Text
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  {//发文编号一栏
                      ...
                      },
                      {
                          ...
                          align: 'stretch', margin: '8 0 8 0', padding: '0 0 0 0',
                          pack: 'start',
                          items: [me.titleText, me.titleText2, me.titleText3,
                              {
                                  xtype: "label",
    ...
    send_create_A17: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA17",
