Ext.define('Ext.plug_ins.ZHEPC_Plugins.MountFile.MountCloseFile', {
    extend: 'Ext.container.Container',
    alias: 'widget.mountCloseFile',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.fileUploadPanel.setGridMinHeight(250);
    ...
    send_upload_atta: function () {
        ...
        me.fileUploadPanel.bIsMountFile = true;
    ...
    send_upload_atta_callback: function (response, options) {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.ZHEPC_Plugins.Document", A: "AfterMountCloseFile",
    ...
    refreshWin: function (parentKeyword, closeWin) {
        ...
        var treeView = Ext.getCmp(me.mainPanelId).up('_mainSourceView').down('_mainProjectTree');

        //调用流程页事件，刷新父控件内容
        treeView.refreshWin(me.docKeyword, function () {
            if (closeWin)
                winMount.close();
