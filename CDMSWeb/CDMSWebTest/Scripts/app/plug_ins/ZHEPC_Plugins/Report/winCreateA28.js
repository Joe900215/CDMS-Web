//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA28', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA28',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.28", readOnly: true,
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.28工程沉降观测报审表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      },
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "工程沉降观测记录，请查验。", margins: "13 0 0 0"
                              }, ]
                      },
                       me.contentText,
                  {
    ...
    send_create_A28: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA28",
