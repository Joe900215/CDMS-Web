//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA11', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA11',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.11", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "现报上", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '10 5 0 0', width: 360//flex: 1
        });
        //添加内容Text
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.11质量验收及评定项目划分报审表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      },
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "工程质量验收及评定项目划分表，请审查。", margins: "13 0 0 0"
                              }]
                      }, me.contentText,
                  {
                      layout: "vbox",
    ...
    send_create_A11: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA11",
