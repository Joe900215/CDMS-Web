//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA2', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA2',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.2", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "第", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '10 5 0 0', width: 200//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "号工程暂停令指出的", anchor: "80%", labelWidth: 125, labelAlign: "left", margin: '10 5 0 0', width: 265//flex: 1
        });
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.2工程复工申请表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      },
                      {
                          ...
                          items: [me.titleText,me.titleText2,
                              {
                                  xtype: "label",
                                  text: "工程停工因素现已全部消除，具备复工条件。", margins: "13 0 0 0"
                              }, ]
                      },
                      {
                          xtype: "label",
                          text: "特报请请审查，请予批准复工。", margins: "0 0 5 0"
                      },
                       me.contentText,
                  {
                      layout: "vbox",
    ...
    send_create_A2: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA2",
