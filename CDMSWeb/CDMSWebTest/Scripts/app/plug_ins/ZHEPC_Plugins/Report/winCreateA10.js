//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA10', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA10',
    //layout: "border",
    layout: 'fit',
    resultvalue: '',mainPanelId:'',mainPanelId:'',
    initComponent: function () {
        var me = this;
        //目录树选取的节点关键字
        me.projectKeyword = "";
        me.winAction = "CreateA10";
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.10", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.Label", {
            ...
            text: " 现报上拟用于本工程的主要测量、计量器具、试验设备及其检验证明，请查验。工程进行中如有调整，将重新统计并上报。"//, anchor: "80%", labelWidth: 220, labelAlign: "left", margin: '10 0 0 0'//, width: 360//flex: 1
        });
        //专工 经手人
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.10主要测量计量器具/试验设备检验报审表', margins: '0 0 0 10'
...
if (title.indexOf("#") > 0) {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA10",
