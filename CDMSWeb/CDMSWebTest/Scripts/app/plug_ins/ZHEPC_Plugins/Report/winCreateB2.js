//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateB2', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateB2',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "B.2", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "主题", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '10 5 0 0', width: 310//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "限", anchor: "80%", labelWidth: 15, labelAlign: "left", margin: '10 5 0 0', width: 165, labelSeparator: ''//flex: 1
        });
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'B.2监理工程师通知单', margins: '0 0 0 10'
    ...
    send_create_B2: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateB2",
