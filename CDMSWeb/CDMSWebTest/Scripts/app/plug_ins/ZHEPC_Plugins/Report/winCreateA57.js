//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA57', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA57',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "整改单编号", anchor: "80%", labelWidth: 70, labelAlign: "left", margin: '10 5 0 00', width: 255//flex: 1
        });
        ...
        me.contentText = Ext.create("Ext.form.field.TextArea", {
            ...
            margin: '8 0 8 0', width: 360, fieldLabel: "整改情况", height: 120
        });
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.57安全问题整改回复单', margins: '0 0 0 10'
    ...
    get_combobox_default: function () {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            me.fileCodePanel.documentTypeText.setValue("A.57");
    ...
    send_create_A57: function () {
        ...
        Ext.require('Ext.plug_ins.ZHEPC_Plugins.Dist.ReportComm', function () {
            ...
            mw.winByName = winA57;
            mw.createDocument(me, 'A.57', projKeyword, fileCode, title, docAttrJson);
        });
    }
});