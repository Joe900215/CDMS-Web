//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA24', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA24',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.24", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "我方已按承包合同要求完成了", anchor: "80%", labelWidth: 160, labelAlign: "left", margin: '10 5 0 0', width: 330//flex: 1
        });
        //添加内容Text
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.24工程竣工报验单', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      }, 
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "工程，经三级自检合格，请予以检查和验收。", margins: "13 0 0 0"
                              }, ]
                      },me.contentText,
                  {
                      layout: "vbox",
    ...
    send_create_A24: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA24",
