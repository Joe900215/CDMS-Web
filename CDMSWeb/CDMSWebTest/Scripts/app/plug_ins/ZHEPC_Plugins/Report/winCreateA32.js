//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA32', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA32',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.32", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "根据《工程建设标准强制性条文》要求，我单位已编制完成", anchor: "80%", labelWidth: 320, labelAlign: "left", margin: '10 5 0 0', width: 450//flex: 1
        });
        //添加内容Text
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.32强条实施计划/细则报审表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      },
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "强制性条文实施计划/细则，特此上报，请予审批。", margins: "13 0 0 0"
                              }, ]
                      },
                       me.contentText,
                  {
    ...
    send_create_A32: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA32",
