//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA14', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA14',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.14", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "我方已完成", anchor: "80%", labelWidth: 75, labelAlign: "left", margin: '10 5 0 0', width: 225//flex: 1
        });
        //添加内容Text
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.14验收申请表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      }, 
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "工程（检验批/分项工程/分部工程/单位工程），经三级自检合格，具备验收条件，现报上该", margins: "13 0 0 0"
                              }, ]
                      },
                      {
                          xtype: "label",
                          text: "工程报验申请表，请予以审查验收。", margins: "0 0 10 0"
                      },me.contentText,
                  {
                      layout: "vbox",
                      width: '100%', baseCls: 'my-panel-no-border',//隐藏边框
    ...
    send_create_A14: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA14",
