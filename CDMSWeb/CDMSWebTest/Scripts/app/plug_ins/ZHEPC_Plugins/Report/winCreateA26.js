//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA26', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA26',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.26", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "根据工程实际施工需要及进场情况，我单位拟于", anchor: "80%", labelWidth: 260, labelAlign: "left", margin: '10 5 0 0', width: 380//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "日将", anchor: "80%", labelWidth: 30, labelAlign: "left", margin: '10 5 0 0', width: 150, labelSeparator: ''//flex: 1
        });
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.26大中型施工机械进场、出场申报表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      },
                      {
                          ...
                          items: [me.titleText,me.titleText2,
                              {
                                  xtype: "label",
                                  text: "施工机械进场/出场，请予以确认。", margins: "13 0 0 0"
                              }, ]
                      },
                       me.contentText,
                  {
    ...
    send_create_A26: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA26",
