//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA16', {
    ...
    initComponent: function () {
        ...
        me.rpTypedata = [{ text: "计划", value: "计划" }, { text: "调整计划", value: "调整计划" }];
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "现报上", anchor: "80%", labelWidth: 50, labelAlign: "left",margin: '10 5 0 0', width: 260//flex: 1
        });

        //添加事由text，xxx计划
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;', labelSeparator: '', // 去掉laebl中的冒号
            fieldLabel: "工程", anchor: "80%", labelWidth: 30, labelAlign: "left", margin: '10 5 0 0', width: 260//flex: 1
        });
        ...
        me.rpTypeCombo = Ext.create("Ext.form.field.ComboBox",
        {
            ...
            displayField: 'text', hideLabel: true, value: "计划",
    ...
    get_combobox_default: function () {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            me.fileCodePanel.documentTypeText.setValue("A.16");
    ...
    send_create_A16: function () {
        ...
        Ext.require('Ext.plug_ins.ZHEPC_Plugins.Dist.ReportComm', function () {
            ...
            mw.winByName = winA16;
            mw.createDocument(me, 'A.16', projKeyword, fileCode, title, docAttrJson);
        });
    }
});