//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateB1', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateB1',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "B.1", readOnly: true,
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'B.1监理工作联系单', margins: '0 0 0 10'
    ...
    send_create_B1: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateB1",
    ...
    //处理服务端创建联系单后的返回事件
    send_create_B1_callback: function (parentKeyword, docKeyword, closeWin) {
        var me = this;
        ...
        //        no: "否"
        //    },
        //    fn: function (btn, parentFuctionName, docKeyword) {
        //        if (btn === "yes") {
                    winB1.close();
                    //启动流程
                    Ext.require('Ext.ux.Common.comm', function () {
