//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateD4', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateD4',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "我单位已编制完成适合本项目工程的", value: "技术标准、规程、规范清单",readOnly:true,
            anchor: "80%", labelWidth: 200, labelAlign: "left", margin: '10 5 0 30', width: 400//flex: 1
        });
        //添加内容Text
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'D.4标准、规程、规范清单报审表', margins: '0 0 0 10'
    ...
    get_combobox_default: function () {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            me.fileCodePanel.documentTypeText.setValue("D.4");
    ...
    send_create_D4: function () {
        ...
        Ext.require('Ext.plug_ins.ZHEPC_Plugins.Dist.ReportComm', function () {
            ...
            mw.winByName = winD4;
            mw.createDocument(me, 'D.4', projKeyword, fileCode, title, docAttrJson);
        });
    }
