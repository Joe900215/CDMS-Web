//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateD3', {
    ...
    initComponent: function () {
        ...
        me.contentText = Ext.create("Ext.form.field.TextArea", {
            ...
            fieldLabel: "内容", height: 120, value: "（详见工程联系单附页）"
        });
    ...
    get_combobox_default: function () {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            me.fileCodePanel.documentTypeText.setValue("D.3");
    ...
    send_create_D3: function () {
        ...
        Ext.require('Ext.plug_ins.ZHEPC_Plugins.Dist.ReportComm', function () {
            ...
            mw.winByName = winD3;
            mw.createDocument(me, 'D.3', projKeyword, fileCode, title, docAttrJson);
        });
    }
