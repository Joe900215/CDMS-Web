//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA22', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA22',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.22", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "现报上第", anchor: "80%", labelWidth: 60, labelAlign: "left",margin: '10 5 0 0', width: 210//flex: 1
        });
        //添加内容Text
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.22设备/材料/构配件缺陷处理报验表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      },
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "号设备/材料/构配件缺陷通知单中所述设备/材料/构配件存在质量缺陷的处理情况报告，请审查。", margins: "13 0 0 0"
                              }, ]
                      },
                       me.contentText,
                  {
    ...
    send_create_A22: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA22",
