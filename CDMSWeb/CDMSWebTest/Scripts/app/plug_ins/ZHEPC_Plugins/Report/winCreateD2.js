//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateD2', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateD2',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "D.2", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "由于", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '10 5 0 0', width: 210//flex: 1
        });
        //添加内容Text
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'D.2工程变更申请单', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      }, 
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "原因，兹申请工程变更（内容见附件），请予以审批。", margins: "13 0 0 0"
                              }, ]
                      },me.contentText,
                  {
                      layout: "vbox",
    ...
    send_create_D2: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateD2",
