Ext.define('Ext.plug_ins.ZHEPC_Plugins.Dist.FileCodePanel', {
    ...
    initComponent: function () {
        ...
        me.crewCloumns=[
        { text: '机组代码', dataIndex: 'crewCode' },
        { text: '机组名称', dataIndex: 'crewDesc' }
        ];
        ...
        me.crewPicker.on('keyup', function (view, e, eOpts) {
            ...
            if (me.crewPicker.picker != undefined) {
                ...
                me.crewstore.proxy.extraParams.Filter = view.getValue();//把参数传给C#MVC,路径：\simplecdms\controllers\Doccontroller.cs 下的 GetWorkFlow()
