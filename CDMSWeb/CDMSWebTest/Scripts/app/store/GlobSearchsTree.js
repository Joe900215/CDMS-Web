//定义 分類树Store
Ext.define("CDMSWeb.store.GlobSearchsTree", {
    extend: 'Ext.data.TreeStore',
    batchActions: false,
    remoteFilter: false,
    remoteSort: false,
    model: "CDMSWeb.model.GlobSearchTree",
    ...
    proxy: {
        ...
        //api: {
        //    read: 'Project/GetProjectListJson?ProjectType=7' + '&sid=' + localStorage.getItem("sid"),//调用路径：\simplecdms\controllers\projectcontroller.cs
        //    create: 'Project/Add',
        ...
        extraParams: {
            ...
            ProjectType: 6, sid: localStorage.getItem("sid")
            //ProjectType: EnProjectType.GlobSearch, sid: localStorage.getItem("sid")
        },
