...
namespace AVEVA.CDMS.WTMS_Plugins
{
    public class Company
    {
        ...
        /// 新建厂家资料目录
        /// </summary>
        public static JObject EditCompany(string sid, string ProjectKeyword, string companyAttrJson)
        {
            return EditCompanyInfo.EditCompany(sid, ProjectKeyword, companyAttrJson);
        }
        ...
        //            {
        //                Project rootProj = CommonFunction.getParentProjectByTempDefn(project, "WTMS_DOCUMENTSYSTEM");
        //                if (rootProj != null)
        //                {
