//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.winBIMView', {
    ...
    initComponent: function () {
        ...
        me.BIMTreeStore = Ext.create("Ext.data.TreeStore", {
            ...
            proxy: {
                ...
                url: 'WebApi/Get',
                extraParams: {
                    C: "AVEVA.CDMS.ZHEPC_Plugins.EnterPoint", A: "GetBIMTreeListJson",
        ...
        me.ParametesGridStore = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                ...
                url: 'WebApi/Get',
                extraParams: {
                    C: "AVEVA.CDMS.ZHEPC_Plugins.EnterPoint", A: "GetBIMNodeParams",
    ...
    sendGetBIMSQLFilePath: function () {
        ...
        if (me.docKeyword != ""){
            ...
            Ext.Ajax.request({
                ...
                method: "Get",
                params: {
                    C: "AVEVA.CDMS.ZHEPC_Plugins.EnterPoint", A: "GetBIMSQLFilePath",
    ...
    sendGetBIMTHMFilePath: function () {
        ...
        if (me.docKeyword != "") {
            ...
            Ext.Ajax.request({
                ...
                method: "Get",
                params: {
                    C: "AVEVA.CDMS.ZHEPC_Plugins.EnterPoint", A: "GetBIMTHMFilePath",
                    sid: localStorage.getItem("sid"), docKeyword: me.docKeyword
                },
                success: function (response, options) {
