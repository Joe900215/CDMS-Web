//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateD1', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateD1',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "D.1", readOnly: true,
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'D.1工程联系单', margins: '0 0 0 10'
    ...
    send_create_D1: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateD1",
