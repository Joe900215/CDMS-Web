//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA4', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA4',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.4", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "现报上", anchor: "80%", labelWidth: 40, labelAlign: "left", margin: '10 5 0 0', width: 280//flex: 1
        });
        //添加内容Text
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.4方案报审表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      }, 
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "工程施工方案/安全方案/调试方案/特殊施工技术方案/采购方案/工艺方案/事故处理/", margins: "13 0 0 0"
                              }, ]
                      },
                      {
                          xtype: "label",
                          text: "节能减排/水土保持/环境保护方案，请审查。", margins: "0 0 10 0"
                      }, me.contentText,
                  {
                      layout: "vbox",
                      width: '100%', baseCls: 'my-panel-no-border',//隐藏边框
    ...
    send_create_a4: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA4",
