//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA35', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA35',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.35", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "现上报", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '10 5 0 0', width: 210//flex: 1
        });
        //添加内容Text
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.35承包单位资质报审表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      }, 
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "（承包单位）资质，我方具有承担下列工程的施工资质和施工能力，可以保证本工程项目按承包", margins: "13 0 0 0"
                              }, ]
                      },
                      {
                          xtype: "label",
                          text: "合同的规定进行施工。请予以审批。", margins: "0 0 10 0"
                      },me.contentText,
                  {
                      layout: "vbox",
                      width: '100%', baseCls: 'my-panel-no-border',//隐藏边框
    ...
    send_create_A35: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA35",
