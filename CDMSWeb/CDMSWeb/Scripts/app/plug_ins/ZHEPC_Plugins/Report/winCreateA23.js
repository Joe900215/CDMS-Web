//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA23', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA23',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.23", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "我方已完成", anchor: "80%", labelWidth: 70, labelAlign: "left", margin: '10 5 0 0', width: 220//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "单位工程，经三级自检合格，具备", anchor: "80%", labelWidth: 190, labelAlign: "left", margin: '10 5 0 0', width: 340//flex: 1
        });
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.23单位工程验收申请表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      },
                      {
                          ...
                          items: [me.titleText,me.titleText2,
                              {
                                  xtype: "label",
                                  text: "验收条件，现报上该工程报验", margins: "13 0 0 0"
                              } ]
                      },{
                          xtype: "label",
                          text: "申请表，请予以审查验收。", margins: "0 0 5 0"
                      },me.contentText,
                  {
                      layout: "vbox",
                      width: '100%', baseCls: 'my-panel-no-border',//隐藏边框
    ...
    send_create_A23: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA23",
