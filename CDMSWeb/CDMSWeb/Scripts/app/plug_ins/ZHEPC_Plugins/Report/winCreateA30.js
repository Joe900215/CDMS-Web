//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA30', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA30',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "承包单位名称", anchor: "80%", labelWidth: 80, labelAlign: "left", margin: '10 5 0 0', width: 300//flex: 1
        });

        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "承包单位法人代表", anchor: "80%", labelWidth: 100, labelAlign: "left", margin: '10 5 0 30', width: 300
        });


        me.select1CheckBox = Ext.create("Ext.form.field.Checkbox", {
            fieldLabel: "根据", margin: '7 5 0 30', labelWidth: 30,
            boxLabel: "合同约定，", labelSeparator: '', // 去掉laebl中的冒号
            listeners: {
                "change": function (view, newValue, oldValue, eOpts) {//添加点击按钮事件
                    me.select2CheckBox.setValue(!newValue);
                }
            }
        });

        me.select2CheckBox = Ext.create("Ext.form.field.Checkbox", {
            fieldLabel: "", margin: '7 5 0 10', labelWidth: 0,
            boxLabel: "有关规定，",
            listeners: {
                "change": function (view, newValue, oldValue, eOpts) {//添加点击按钮事件
                    me.select1CheckBox.setValue(!newValue);
                }
            }
        });
        ...
        me.contentGrid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                {
                    header: '总承包工程名称', dataIndex: 'name', width: 250,
                    editor: {
                        allowBlank: false
                    }
                },
                ...
                {
                    header: '拟总承包工程合同额', dataIndex: 'amount', width: 150,
                    editor: {
                        allowBlank: false
                    }
                },
                {
                    header: '总承包工程占全部工程比例', dataIndex: 'scale', width: 155,
                    editor: {
                        allowBlank: false
                    }
                }
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.30总承包单位资质报审表', margins: '0 0 0 10'
                          ...
                          me.fileCodePanel,
                               {
                                   ...
                                   pack: 'start',
                                   items: [me.select1CheckBox, me.select2CheckBox,
                                    {
                                        xtype: "label",
                                        text: "我单位有资质、有能力完成本承包工程，并保证本项承包工程将按全部", margins: "10 5 0 0", labelWidth: 60
                                    }
                                    ]
                               },
                            {
                                ...
                                items: [
                                    {
                                        xtype: "label",
                                        text: "合同文件的规定进行。", margins: "0 5 0 0", labelWidth: 60
                                    }
                                   ]
                            },
                            {
    ...
    get_combobox_default: function () {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            me.fileCodePanel.documentTypeText.setValue("A.30");
    ...
    send_create_A30: function () {
        ...
        //添加金额合计
        var FORM1 = me.amountCountText === undefined ? "" : me.amountCountText.value;
        //添加比例合计
        var FORM2 = me.scaleCountText === undefined ? "" : me.scaleCountText.value;
        ...
        Ext.require('Ext.plug_ins.ZHEPC_Plugins.Dist.ReportComm', function () {
            ...
            mw.winByName = winA30;
            mw.createDocument(me, 'A.30', projKeyword, fileCode, title, docAttrJson);
        });
    }
