//新建目录
Ext.define('Ext.plug_ins.ZHEPC_Plugins.Report.winCreateA53', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateA53',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.select1CheckBox = Ext.create("Ext.form.field.Checkbox", {
            ...
            boxLabel: "安全（质量）管理体系网络图"
        });

        me.select2CheckBox = Ext.create("Ext.form.field.Checkbox", {
            fieldLabel: "", margin: '2 5 0 10', labelWidth: 0, checked: true,
            boxLabel: "安全（质量）管理制度清单(总承包报制度、施工单位报清单)"
        });
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.53安全（质量)管理体系报审表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      items: [
                          me.fileCodePanel,
                          {
                              ...
                              {
                                  xtype: "label",
                                  text: "工程质量管理体系，请予审查。", margins: "13 0 0 0"
                              }, ]
                          },
                          {
                              layout: "hbox",
    ...
    get_combobox_default: function () {
        ...
        if (nodes !== null && nodes.length > 0) {
            ...
            me.fileCodePanel.documentTypeText.setValue("A.53");
    ...
    send_create_A53: function () {
        ...
        Ext.require('Ext.plug_ins.ZHEPC_Plugins.Dist.ReportComm', function () {
            ...
            mw.winByName = winA53;
            mw.createDocument(me, 'A.53', projKeyword, fileCode, title, docAttrJson);
        });
    }
