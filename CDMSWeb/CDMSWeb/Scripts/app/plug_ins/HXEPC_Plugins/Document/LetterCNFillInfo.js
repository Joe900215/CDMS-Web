//选择专业
Ext.define('Ext.plug_ins.HXEPC_Plugins.Document.letterCNFillInfo', {
    extend: 'Ext.container.Container',
    alias: 'widget.letterCNFillInfo',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.sendCodeText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "发文编码", anchor: "80%", labelWidth: 60, labelAlign: "right", labelPad: 8, width: "50%",//width: 230, 
            margin: '10 10 0 10', fieldStyle: 'border-color: red; background-image: none;'//红色边框//flex: 1
        });
    ...
    //向服务器发送文控填写发文信息请求
    send_letterCNFillInfo: function () {
        var me = this;
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.HXEPC_Plugins.Document", A: "LetterCNFillInfo",
                sid: localStorage.getItem("sid"), DocKeyword: me.docKeyword,
                DocAttrJson: docAttrJson
            },
            success: function (response, options) {
                me.send_letterCNFillInfo_callback(response, options, "");//, me.projectKeyword, closeWin);
    ...
    send_letterCNFillInfo_callback: function (response, options) {
        var me = this;
                ...
                fn: function (btn, parentFuctionName) {
                    if (btn === "yes") {
                        ...
                        Ext.require('Ext.ux.Common.comm', function () {
                            GotoNextWorkflowState("TOEND", me.workFlowKeyword ,"", function () {
                                //回调函数，通过流程分支
