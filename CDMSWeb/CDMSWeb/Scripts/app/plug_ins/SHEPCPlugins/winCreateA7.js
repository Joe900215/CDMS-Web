//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA7', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.7", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.Label", {
            ...
            text: " 现报上本项目部主要管理人员∕特殊工种/特种作业人员名单及其资格证件，请查验。工程进行中如有调整，将重新统计并上报。"//, anchor: "80%", labelWidth: 220, labelAlign: "left", margin: '10 0 0 0'//, width: 360//flex: 1
        });
        ...
        //    data: {
        //        'items': [
        //            { '姓 名': '1', "岗位/工种": " ", "证件名称": " ", "证件编号": " ", "发证单位": " ", "有效期": " " },
        //            { '姓 名': '1', "岗位/工种": "2", "证件名称": "3", "证件编号": "4", "发证单位": "5", "有效期": "6" },
        //            { '姓 名': '1', "岗位/工种": " ", "证件名称": " ", "证件编号": " ", "发证单位": " ", "有效期": " " },
        //            { '姓 名': '1', "岗位/工种": " ", "证件名称": " ", "证件编号": " ", "发证单位": " ", "有效期": " " },
        //            { '姓 名': '1', "岗位/工种": " ", "证件名称": " ", "证件编号": " ", "发证单位": " ", "有效期": " " },
        //            { '姓 名': '1', "岗位/工种": " ", "证件名称": " ", "证件编号": " ", "发证单位": " ", "有效期": " " }
        ...
        //    //store:me.contentStore,
        //    columns: [
        //        { header: '姓 名', dataIndex: '姓 名', width: 115 },
        //        { header: '岗位/工种', dataIndex: '岗位/工种', width: 115 },
        //        { header: '证件名称', dataIndex: '证件名称', width: 115 },
        //        { header: '证件编号', dataIndex: '证件编号', width: 115 },
        //        { header: '发证单位', dataIndex: '发证单位', width: 115 },
        //        { header: '有效期', dataIndex: '有效期', width: 115 },
        //    ],  
        //    selType: 'cellmodel',
        //    plugins:[  
        //         Ext.create('Ext.grid.plugin.CellEditing',{  
...
if (title.indexOf("#") > 0) {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA7",
