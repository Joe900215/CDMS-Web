//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateC2', {
    extend: 'Ext.container.Container',
    alias: 'widget.winCreateC2',
    //layout: "border",
    layout: 'fit',
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "C.2", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "现报上", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '10 5 0 0', width: 190//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "工程", anchor: "80%", labelWidth: 30, labelAlign: "left", margin: '10 5 0 0', width: 160//flex: 1
        });
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'C.2设计文件报检表', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      },
                      {
                          ...
                          items: [me.titleText,me.titleText2,
                              {
                                  xtype: "label",
                                  text: "设计文件，请会检。", margins: "13 0 0 0"
                              }, ]
                      },
                       me.contentText,
                  {
    ...
    send_create_C2: function () {
        ...
        Ext.Ajax.request({
            url: 'SHEPCPlugins/CreateC2',
            method: "POST",
            params: {
                //IsUpEdition:是否升版,filelist：文件列表，action：操作命令
                action: me.winAction, ProjectKeyword: projKeyword, docNum: me.docNum,
                title: title, content: content, filelist: filelist, IsUpEdition: "flase", sid: localStorage.getItem("sid")
            },
            success: function (response, options) {
