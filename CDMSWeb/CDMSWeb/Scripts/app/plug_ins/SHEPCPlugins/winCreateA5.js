//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA5', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.5", readOnly: true,
            ...
            listeners:
{
    ...
    send_create_A5: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA5",
