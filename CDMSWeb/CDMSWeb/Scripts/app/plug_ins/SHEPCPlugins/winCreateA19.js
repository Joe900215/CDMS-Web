//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA19', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.19", readOnly: true,
        ...
        me.fromDateField = Ext.create("Ext.form.field.Date", {
            ...
            anchor: '100%',
            fieldLabel: ' 我方于',
            labelWidth: 60, labelAlign: "left", margin: '10 0 0 0',
            format: 'Y年m月d日',
            name: 'to_date',
        ...
        me.toDateField = Ext.create("Ext.form.field.Date", {
            ...
            anchor: '100%',
            fieldLabel: '---',
            labelWidth: 15, labelAlign: "left", margin: '10 5 0 5', labelSeparator: '',
            format: 'Y年m月d日',
            name: 'to_date',
            value: new Date()  // defaults to today
        });
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "共完成合同价款", anchor: "80%", labelWidth: 90, labelAlign: "left", margin: '10 5 0 0', width: 260//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "规定扣除", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '0 5 0 0', width: 170//flex: 1
        });
        //添加事由text
        me.titleText3 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "%预付款和", anchor: "80%", labelWidth: 70, labelAlign: "left", margin: '0 5 0 0', width: 170,labelSeparator:''//flex: 1
        });
        //添加事由text
        me.titleText4 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "%质量保证金，特申请支付进度款", anchor: "80%", labelWidth: 190, labelAlign: "left", margin: '0 5 0 0', width: 290//flex: 1
        });
        ...
        me.unitCombo = Ext.create("Ext.form.field.ComboBox",
        {
            ...
            emptyText: "请选择", autoLoadOnValue: true,anchor: "80%", labelAlign: "left", width: 100,//, margins: "8"
            listeners:
            {
        ...
        me.professionCombo = Ext.create("Ext.form.field.ComboBox",
        {
            ...
            valueField: 'value', editable: false,//不可输入
            displayField: 'text', hideLabel: true,
            emptyText: "请选择", autoLoadOnValue: true,anchor: "80%", labelAlign: "left", width: 96,//, margins: "8"
            listeners:
            {
                select: function (combo, records, eOpts) {
                    //获取流水号
    ...
    send_create_A19: function () {
        ...
        var fromDate = me.fromDateField.value;
        var title = me.titleText.value;
		if (title.indexOf("#") > 0) {
            Ext.Msg.alert("系统提示", "文件名称中包含非法字符 # 请去掉！");
            return;
        }
        var title2 = me.titleText2.value;
        var title3 = me.titleText3.value;
        var title4 = me.titleText4.value;
