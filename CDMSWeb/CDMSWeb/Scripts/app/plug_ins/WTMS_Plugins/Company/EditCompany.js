//新建参建单位资料目录
Ext.define('Ext.plug_ins.WTMS_Plugins.Company.EditCompany', {
    ...
    sendEditCompanyDefault: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.WTMS_Plugins.Company", A: "GetEditCompanyDefault",
    ...
    send_editCompany: function (isCreate) {
        ...
        //var secretarilman = me.secretarilmanList; // me.secretarilmanText.value;//
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.WTMS_Plugins.Company", A: A,
                sid: localStorage.getItem("sid"), ProjectKeyword: me.projectKeyword,
    ...
    send_createCompanyProject: function () {
        ...
        var secretarilman = me.secretarilmanText.value;
        //var secretarilman = me.secretarilmanList;
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.WTMS_Plugins.Company", A: "CreateCompanyProject",
                sid: localStorage.getItem("sid"), ProjectKeyword: me.projectKeyword,
    ...
    bat_new_company: function () {
        ...
        //弹出操作窗口
        var _fmBatchCreateCompany = Ext.create('Ext.plug_ins.WTMS_Plugins.Project.BatchCreateCompany', { title: "" });
                ...
                fn: function (btn) {
                    if (btn === "yes") {
                        ...
                        Ext.Ajax.request({
                            ...
                            method: "POST",
                            params: {
                                C: "AVEVA.CDMS.WTMS_Plugins.Company", A: "DeleteCompany",
                                sid: localStorage.getItem("sid"), ProjectKeyword: me.projectKeyword,
