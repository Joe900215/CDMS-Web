//发文处理
Ext.define('Ext.plug_ins.m.HXPC_Plugins.sendDocument', {
    ...
    initComponent: function () {
        ...
        me.ProjectText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldLabel: "项目号", labelWidth: 0, readOnly: true, labelSeparator: '', // 去掉laebl中的冒号
        ...
        me.NumberText = Ext.create("Ext.form.field.Text", {
            ...
            anchor: "80%", labelAlign: "top", flex: 1//flex: 1
        });
        ...
        me.NoteText = Ext.create("Ext.form.field.TextArea", {
            xtype: "textarea", anchor: "80%", labelAlign: "left", margin: '2 0 0 0', labelSeparator: '', // 去掉laebl中的冒号
            //height: 100,
            fieldLabel: "增加意见", labelAlign: "left", labelWidth: 50, flex: 1
        });
        ...
        me.replyDateField = Ext.create("Ext.form.field.Date", {
            ...
            editable: true, labelWidth: 50, margin: '0 0 0 0', labelSeparator: '', // 去掉laebl中的冒号
        ...
        {
            //xtype: "combo",
            fieldLabel: '收文单位', labelWidth: 10, labelSeparator: '', // 去掉laebl中的冒号
        ...
        {
            //xtype: "combo",
            fieldLabel: '是否回文', labelWidth: 50, 
            triggerAction: "all", store: me.ifStore,
            valueField: 'value', editable: false,//不可输入
            displayField: 'text', margin: '0 10 0 0', labelSeparator: '', // 去掉laebl中的冒号
            anchor: "80%", labelAlign: "left", width: 125,//
            emptyText: "--请选择--", autoLoadOnValue: true,
            //fieldStyle: 'border-color: red; background-image: none;',//红色边框
            listeners:
            {
        ...
        {
            //xtype: "combo",
            fieldLabel: '发放路径', labelWidth: 50,
            triggerAction: "all", store: me.routeStore,
            valueField: 'value', editable: false,//不可输入
            displayField: 'text', margin: '0 0 0 0', labelSeparator: '', // 去掉laebl中的冒号
            anchor: "80%", labelAlign: "left", flex:1,//width: 170,//
            emptyText: "--请选择--", autoLoadOnValue: true,
            //fieldStyle: 'border-color: red; background-image: none;',//红色边框
            listeners:
            {
...

                  {
                      ...
                      items: [
                          ...
                          //},
                          {
                              ...
                              items: [
                                  {
                                      xtype: "fieldset", margin: '0 0 0 0',padding:'0 5 3 5',
                                      title:"函件编码",
                                      layout: {
                                          type: 'vbox',
                                          pack: 'start',
                                  ...
                                  {
                                      xtype: "fieldset", margin: '5 0 0 0', padding: '0 5 3 5',
                                      title: "函件主题",
                                      layout: {
                                          type: 'hbox',
                                          pack: 'start',
                                      ...
                                      items: [
                                          {
                                              ...
                                              margin: '2 0 0 0', baseCls: 'my-panel-no-border',//隐藏边框
                                              items: [
    ...
    sendGetSendDocumentDefault_callback: function (response, options) {
        ...
        if (state === true) {
            ...
            me.companyProxy.data = me.companydata;
