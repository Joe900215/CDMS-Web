//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA6', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.6", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "经我方审查", anchor: "80%", labelWidth: 80, labelAlign: "left",margin: '10 5 0 0', width: 280//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "单位可提供工程需要的", anchor: "80%", labelWidth: 130, labelAlign: "left", margin: '10 5 0 0', width: 280//flex: 1
        });
    ...
    send_create_A6: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA6",
