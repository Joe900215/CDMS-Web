//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA3', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.3", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "我方已根据承包合同的有关规定完成了", anchor: "80%", labelWidth: 220, labelAlign: "left", margin: '10 5 0 0', width: 360//flex: 1
        });
        //添加内容Text
                  ...
                  {//发文编号一栏
                      ...
                      }, 
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "工程施工组织设计（项目管理实施规划）的编制，并经我单位技术", margins: "13 0 0 0"
                              }, ]
                      },
                      {
                          xtype: "label",
    ...
    send_create_a3: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA3",
