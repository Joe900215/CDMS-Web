//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA30', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.30", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "现上报", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '10 5 0 0', width: 225//flex: 1
        });
        //添加内容Text
            ...
            listeners:
{
                  ...
                  {//发文编号一栏
                      ...
                      }, 
                      {
                          ...
                          items: [me.titleText,
                              {
                                  xtype: "label",
                                  text: "（总承包单位）资质，我方具有承担下列工程的施工资质和施工能力，可以保证本工程项目按", margins: "13 0 0 0"
                              }, ]
                      },
                      {
                          xtype: "label",
                          text: "总承包合同的规定进行施工。请予以审批。", margins: "0 0 10 0"
                      },me.contentText,
                  {
                      layout: "vbox",
                      width: '100%', baseCls: 'my-panel-no-border',//隐藏边框
    ...
    send_create_A30: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA30",
