//新建目录
Ext.define('Ext.plug_ins.SHEPCPlugins.winCreateA34', {
    ...
    initComponent: function () {
        ...
        me.postCategoryText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", hideLabel: true, value: "A.34", readOnly: true,
        ...
        me.titleText = Ext.create("Ext.form.field.Text", {
            ...
            fieldLabel: "提出单位", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '0 10 10 0', width: 190//flex: 1
        });
        //添加事由text
        me.titleText2 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "编号", anchor: "80%", labelWidth: 30, labelAlign: "left", margin: '0 10 10 0', width: 150//flex: 1
        });
        //添加事由text
        me.titleText3= Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "项目名称", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: '0 10 10 0', width: 190//flex: 1
        });
        //添加事由text
        me.titleText4 = Ext.create("Ext.form.field.Text", {
            xtype: "textfield", fieldStyle: 'border-color: red; background-image: none;',
            fieldLabel: "时间", anchor: "80%", labelWidth: 30, labelAlign: "left", margin: '0 10 10 0', width: 150//flex: 1
        });
            ...
            listeners:
{
              ...
              items: [{
                  ...
                  items: [
                          ...
                          items: [{ baseCls: 'my-panel-no-border', flex: 1 },
                      {
                          ...
                          cls: 'classDiv2',
                          itemId: 'label1',
                          text: 'A.34工程量确认单（合同范围内）', margins: '0 0 0 10'
                  ...
                  {//发文编号一栏
                      ...
                      }, 
                      {
                          ...
                          pack: 'start',
                          items: [
                              me.titleText, me.titleText2, me.titleText3, me.titleText4,
                          ]
                      }, me.contentText,
    ...
    send_create_A34: function () {
        ...
        Ext.Ajax.request({
            ...
            method: "POST",
            params: {
                C: "AVEVA.CDMS.SHEPC_Plugins.EnterPoint", A: "CreateA34",
