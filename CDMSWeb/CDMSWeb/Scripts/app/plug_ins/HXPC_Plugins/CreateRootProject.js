//项目立项
Ext.define('Ext.plug_ins.HXPC_Plugins.CreateRootProject', {
    ...
    initComponent: function () {
        ...
        me.unitManPhoneText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "甲方联系人电话", anchor: "80%", labelWidth: 95, labelAlign: "left", width: 230, margin: '0 10 0 10', fieldStyle: ' background-image: none;'//红色边框//flex: 1
        });

        //定义主要设计原则Text
        me.designPrincText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "主要设计原则", anchor: "80%", labelWidth: 85, labelAlign: "left", width: 230, margin: '0 10 0 10', fieldStyle: ' background-image: none;'//红色边框//flex: 1
        });
        ...
        me.editRequireText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "文本编辑规定", anchor: "80%", labelWidth: 85, labelAlign: "left", width: 230, margin: '0 10 0 10', fieldStyle: ' background-image: none;'//红色边框//flex: 1
        });
        ...
        me.releaseDateField = Ext.create("Ext.form.field.Date", {
            ...
            editable: true, labelWidth: 85, margin: '0 10 0 10',
        ...
        {
            //xtype: "combo",
            fieldLabel: '工程实施性质', labelWidth: 85,
        ...
        {
            //xtype: "combo",
            fieldLabel: '项目开发阶段', labelWidth: 85,
            ...
            success: function (response, options) {
                try {
                    ...
                    if (state === true) {
                        ...
                        //me.designPhaseCombo.load();//必须loadStore后再设置combobox的值
 
                        me.designPhaseCombo.setRawValue(me.designPhasedata[0].text);//设置显示值
                        me.designPhaseCombo.setValue(me.designPhasedata[0].value); //设置ID值
                        ...
                        me.contractModelStore.proxy.setData(me.contractModeldata);

                        me.contractModelCombo.setRawValue(me.contractModeldata[0].text);//设置显示值
                        me.contractModelCombo.setValue(me.contractModeldata[0].value); //设置ID值
                        ...
                        me.developmentPhaseStore.proxy.setData(me.developmentPhasedata);

                        me.developmentPhaseCombo.setRawValue(me.developmentPhasedata[0].text);//设置显示值
                        me.developmentPhaseCombo.setValue(me.developmentPhasedata[0].value); //设置ID值
                        ...
                        me.projectNatureStore.proxy.setData(me.projectNaturedata);

                        me.projectNatureCombo.setRawValue(me.projectNaturedata[0].text);//设置显示值
                        me.projectNatureCombo.setValue(me.projectNaturedata[0].value); //设置ID值
                        ...
                        me.projectTypeStore.proxy.setData(me.projectTypedata);

                        me.projectTypeCombo.setRawValue(me.projectTypedata[0].text);//设置显示值
                        me.projectTypeCombo.setValue(me.projectTypedata[0].value); //设置ID值
