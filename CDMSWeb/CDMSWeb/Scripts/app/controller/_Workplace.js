Ext.define('CDMSWeb.controller._Workplace', {
    ...
    views: [
        '_Workplace.View', 'Ext.ux.YDForm._contextMenu'
    ],
    ...
    refs: [
         ...
         { ref: "_WorkplacePanel", selector: "#_workplacePanel" }
    ...
    init: function () {
        var me = this,
            panel = me.get_WorkplacePanel();  //获取ContentPanel实例

        me.view = Ext.widget("_workplaceview");//视图路径：\Scripts\app\view\Content\View.js
        panel.add(me.view);
