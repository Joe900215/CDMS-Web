//新建目录
Ext.define('Ext.ux.YDForm.Project._ModiProjAttr', {
    ...
    initComponent: function () {
        ...
        me.projectNameText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "名字", anchor: "80%", labelWidth: 60, labelAlign: "left", width: 360, margin: "17 8 17 8",fieldStyle: 'border-color: red; background-image: none;',//红色边框//flex: 1
            data: []
        });
        ...
        {
            xtype: "textfield",
            fieldLabel: "描述", anchor: "80%", labelWidth: 60, labelAlign: "left", width: 360, margin: "17 8 17 8"
        });
        ...
        me.parentKeyword = "";//目录Keyword,与projectKeyword不同的是，如果选择了创建根文件夹时parentKeyword="Root"
        ...
        me.storageCombo = Ext.create("Ext.form.field.ComboBox",
        {
            ...
            fieldLabel: "存储", anchor: "80%", labelWidth: 60, labelAlign: "left", margin: "17 8 17 8", width: 360
        ...
        me.tempDefnCodeText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "模板", readOnly: true, anchor: "80%", labelWidth: 60, labelAlign: "left", width: 360, margin: "17 8 17 8"
        });

        //定义模板描述文本框
        me.tempDefnDescText = Ext.create("Ext.form.field.Text", {
            xtype: "textfield",
            fieldLabel: "描述", readOnly: true, anchor: "80%", labelWidth: 60, labelAlign: "left", width: 360, margin: "17 8 17 8"
        ...
        me.isHideCheckBox = Ext.create("Ext.form.field.Checkbox", {
            ...
            boxLabel: "隐藏",
            anchor: "",
            hideLabel: true, margin: "5"
        });

        me.isRootCheckBox = Ext.create("Ext.form.field.Checkbox", {
            xtype: "checkbox",
            fieldLabel: "",
            boxLabel: "创建根文件夹",
            anchor: "", hidden: true,
          ...
          Ext.widget('form', {
                                    ...
                                    items: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                {
                                                    xtype: "button",
                                                    text: "选择", margin: "17 8 17 8", width: 60,
                                                    listeners: {
              ...
              },
              {
                  ...
                  items: [{
                      ...
                      {
                          xtype: "button",
                          text: "确定", width: 60, margin: "18 5 18 5",
                          listeners: {
                              "click": function (btn, e, eOpts) {//添加点击按钮事件
                      ...
                      {
                          xtype: "button",
                          text: "取消", width: 60, margin: "18 5 18 5",
                          listeners: {
                              "click": function (btn, e, eOpts) {//添加点击按钮事件
                                  win.close();
                              }
                  ...
                  {
                      xtype: "button",
                      text: "应用", width: 60, margin: "18 15 18 5",
                      listeners: {
                          "click": function (btn, e, eOpts) {//添加点击按钮事件
            ...
            success: function (response, options) {
                try {
                    ...
                    if (state === false) {
                        ...
                        me.storageCombo.setValue(storagelist[0].storagename);//设置显示值
                        //me.storageCombo.setRawValue(storagelist[0].storagetext); //设置ID值
    ...
    update_Project_attr: function (closeWin) {
        ...
        var storageName = me.storageCombo.getValue();
        var storageName2 = me.storageCombo.getRawValue();
        var isHide = me.isHideCheckBox.checked;
        var isRoot = me.isRootCheckBox.checked;
        ...
        [{ name: 'projectName', value: projectName },
            ...
            { name: 'isRoot', value: isRoot }
        ];
        var projectAttrJson = Ext.JSON.encode(projectAttr);

        me.parentKeyword = me.projectKeyword;
        //是否在根目录下创建
        if (me.winAction === "CreateProject" && isRoot === true)
        ...
        //        else {
                    ...
                    Ext.Ajax.request({
                        ...
                        method: "POST",
                        params: {
                            C: "AVEVA.CDMS.WebApi.ProjectController", A: action,//"UpdateProjectAttr",action: me.winAction,
                            sid: localStorage.getItem("sid"),  projectKeyword: me.parentKeyword, projectAttrJson: projectAttrJson
                        },
                        success: function (response, options) {
