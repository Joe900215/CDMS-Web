...
Ext.define("Ext.ux.gcz.Login", {
    ...
    initComponent: function () {
        ...
        me.userText = Ext.create("Ext.form.field.Text", {
            fieldLabel: "用户名", name: "UserName", anchor: "80%", labelWidth: '100%', labelAlign: "left",
        ...
        me.pswText = Ext.create("Ext.form.field.Text", {
            fieldLabel: "密码", name: "Password", inputType: "password", anchor: "80%", labelWidth: '100%',
