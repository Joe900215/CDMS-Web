Ext.define('Ext.ux.m.User._UserSelector', {
    ...
    initComponent: function () {
        ...
        ////定义用户选择Tab
        me._sourceSelectUserTab = Ext.create('Ext.ux.m.User._SelectUserTab');
        ...
        me.btnPlan = {
            ...
            {
                xtype: "button",
                text: "确定", width: 80, margin: "5 5 5 5",
                listeners: {
                    "click": function (btn, e, eOpts) {//添加点击按钮事件
                        //var tab = me._sourceSelectUserTab;
                        //确定按钮事件
                        var strresult, strname;
                        var resultstore;
                        if (me._sourceSelectUserTab.activeTab.title === "组织机构")
                        { resultstore = me._sourceSelectUserTab._selectGroupUserPanel.resultgrid.getStore(); }
                        else {
                            resultstore = me._sourceSelectUserTab.resultgrid.getStore();
                        }
                        // var resultstore = me.resultgrid.getStore();
                ...
                xtype: "button",
                text: "取消", width: 80, margin: "5 5 5 5",
                listeners: {
                    "click": function (btn, e, eOpts) {//添加点击按钮事件
                        _winUserSelector.close();
                    }
