      ...
      onActiveChanged: function(isActive) {
        ...
        if (isActive) {
          toggleHandTool.title =
            mozL10n.get('hand_tool_disable.title', null, '禁用移动工具');
          toggleHandTool.firstElementChild.textContent =
            mozL10n.get('hand_tool_disable_label', null, '禁用移动工具');
        } else {
          toggleHandTool.title =
            mozL10n.get('hand_tool_enable.title', null, '启用移动工具');
          toggleHandTool.firstElementChild.textContent =
            mozL10n.get('hand_tool_enable_label', null, '启用移动工具');
        }
      }
    });
    if (toggleHandTool) {
...
function webViewerInitialized() {
  ...
  var pparam = 'p' in params ? ('?p=' + params.p) : "";
  pparam=pparam.replace("+","%2B")+"=";   
  file = file + pparam;
...
window.addEventListener('resize', function webViewerResize(evt) {
    if (PDFView != undefined && PDFView.initialized &&
