        ...
        internal static Hashtable GetHashtable(Doc doc, string docType, string fileCode, string title, string docAttrJson)
        {
            ...
            try
            {
                ...
                foreach (JObject joAttr in jaAttr)
                {
                    ...
                    if (strName == "title4") title4 = strValue.Trim();

                }
            
                htUserKeyWord.Add("FILECODE", fileCode);
                htUserKeyWord.Add("TEXT3", title);//工程名称
                htUserKeyWord.Add("TEXT1", title2);//变更内容
                htUserKeyWord.Add("TEXT2", title3);//变更单编号
                htUserKeyWord.Add("ENCLOSURE", title4);//附件
            }
            catch
            {
