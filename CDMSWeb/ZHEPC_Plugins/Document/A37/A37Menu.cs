...
{
    internal class A37Menu : ExWebMenu
    {
        ...
        {
            return ReportMenu.GetReportMenuState(base.Sid, base.SelProjectList, "A.37");
            //enWebMenuState hide = enWebMenuState.Hide;
            //try
            //{
            //    string str2 = "CONTACTTYPE";
            //    if (((base.SelProjectList != null) && (base.SelProjectList.Count == 1)) && 
            //        ((base.SelProjectList[0].TempDefn != null) && 
            //        (base.SelProjectList[0].TempDefn.KeyWord == str2)
            //        && (base.SelProjectList[0].Code == "A.37")))
            //    {
