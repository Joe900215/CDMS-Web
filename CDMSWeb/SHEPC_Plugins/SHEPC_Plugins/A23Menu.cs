...
{
    internal class A23Menu : ExWebMenu
    {
        ...
        public override enWebMenuState MeasureMenuState()
        {
            ...
            try
            {
                ...
                if (((base.SelProjectList != null) && (base.SelProjectList.Count == 1)) && ((base.SelProjectList[0].TempDefn != null) && (base.SelProjectList[0].TempDefn.KeyWord == str2) && (base.SelProjectList[0].Code == "A.23")))
                {
