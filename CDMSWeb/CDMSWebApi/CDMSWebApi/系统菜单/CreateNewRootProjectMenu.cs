...
{
    internal class CreateNewRootProjectMenu : ExWebMenu
    {
        ...
        public override enWebMenuState MeasureMenuState()
        {
            ...
            {
                //只有在普通目录页面，才显示
                if (base.SelProjectList != null && base.SelProjectList.Count > 0 && base.SelProjectList[0].O_type != enProjectType.Local)
                {
