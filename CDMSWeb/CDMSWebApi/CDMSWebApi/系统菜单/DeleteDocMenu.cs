...
{
    internal class DeleteDocMenu : ExWebMenu
    {
        ...
        public override enWebMenuState MeasureMenuState()
        {
            ...
            try
            {
                ...
                //bool hasDDeleteRight = DocController.GetDocDDeleteRight(doc,base.SidCode);
                bool hasDDeleteRight = DocController.GetDocDDeleteRight(doc, base.Sid);
                    //有删除目录权限才可以删除目录
                if (hasDDeleteRight && doc.O_dmsstatus == (enDocStatus)2)
