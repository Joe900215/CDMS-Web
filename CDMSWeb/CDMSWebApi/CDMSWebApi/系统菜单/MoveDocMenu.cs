...
{
    internal class MoveDocMenu : ExWebMenu
    {
        ...
        public override enWebMenuState MeasureMenuState()
        {
            ...
            try
            {
                ...
                bool hasDocDDeleteRight = DocController.GetDocDDeleteRight(doc, base.Sid);

                //有删除目录权限才可以剪切目录
                if (hasDocDFWriteRight && hasDocDDeleteRight && doc.O_dmsstatus == (enDocStatus)2)
