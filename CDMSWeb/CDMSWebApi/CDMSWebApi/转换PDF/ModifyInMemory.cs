...
namespace AVEVA.CDMS.WebApi
{
    public static class AsposeModifyInMemory
    {
        ...
        private static string AsposeList = "Aspose.3D.dll, Aspose.BarCode.dll, Aspose.BarCode.Compact.dll, Aspose.BarCode.WPF.dll, Aspose.CAD.dll, Aspose.Diagram.dll, Aspose.Email.dll, Aspose.Imaging.dll, Aspose.Note.dll, Aspose.OCR.dll, Aspose.Slides.dll, Aspose.Tasks.dll";
